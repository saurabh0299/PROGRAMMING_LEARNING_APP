...
public class androiddatabase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_androiddatabase);
        ...
        theory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(androiddatabase.this,atheorydatabse.class);
        ...
        video.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(androiddatabase.this,avideodatabse.class);
                startActivity(intent);
            }
        });
